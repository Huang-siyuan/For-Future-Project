 ...
 * The baseMapper is from mybatis-plus.
 * BaseMapper can provide some basic sql operations.
 * More details see: <a href="https://baomidou.com/">https://baomidou.com/</a>
 */
public interface UserMapper extends BaseMapper<User> {
     ...
     */
    @Insert("insert into t_user(username, password, phone, email, gender, avatar, created_user, created_time, modified_user, modified_time, is_deleted) " +
            "values (#{username},#{password}, #{phone}, #{email}, #{gender}, #{avatar}, #{createdUser}, #{createdTime}, #{modifiedUser}, #{modifiedTime}, #{isDeleted})")
